      ...
      <div class="card-deck">
        <div class="col-sm-12 col-md-6 col-lg-4 col-sm-12 mb-5 mb-lg-0">
          <div class="card shadow-sm mb-0">
            ...
            <div class="card-body">
              <h4 class="card-title">FX Calculator</h4>
              <h6 class="card-subtitle text-muted mb-2">
                Web Application
                <span class="badge badge-pill badge-info">Nuxt</span>
              </h6>
              <p class="card-text">
                A calculating app made with Nuxt.js that you can simulate
                FX unrealized profit / loss and margin rate.
              </p>
              <a
        ...
        <div class="col-sm-12 col-md-6 col-lg-4 mb-5 mb-lg-0">
          <div class="card shadow-sm mb-0">
            ...
            <div class="card-body">
              <h4 class="card-title">Kokonokore</h4>
              <h6 class="card-subtitle text-muted mb-2">
                Web Service
                <span class="badge badge-pill badge-info">Rails</span>
              </h6>
              <p class="card-text">
                A web service made with Ruby on Rails that you can share
                recommended gourmet food of restaurants.
              </p>
              <a
